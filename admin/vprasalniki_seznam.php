...
function sort_lst(url_vrednost) {
	location.href = 'index.php?akcija=vpr_sez&limit=$_GET[limit]&'+url_vrednost;
}
...
<b>Seznam enot z osnovno statistiko</b><br>
Stran: <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=0'>1</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=100'>2</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=200'>3</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=300'>4</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=400'>5</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=500'>6</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=600'>7</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=700'>8</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=800'>9</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=900'>10</a> | <a href='index.php?akcija=vpr_sez&sortiraj=$_GET[sortiraj]&updown=$_GET[updown]&limit=all'>vse</a><br>Sortiraj: <select name="sort" id="seznam_lst_1" onchange="sort_lst(this.value)">$sort_list</select>
